...
card_info = {
    ...
    1034: ("Parry", 2, 1, 2, 'Gain 12 block. Whenever you are attacked this turn, apply 2 Vulerable to the attacker.', False, False, False, False, {effects.block_gain_card: (12, 1), effects.apply_buff: (['parry'], [1])}, 0),
    ...
    1058: ("Void Strike", 3, 0, 0, 'Deal 3 damage. Apply 2 Vulnerable. 2 Weak and 2 Poison. Exhaust.', False, True, False, False, {effects.deal_attack_damage: (3, 1), effects.apply_debuff: (['Vulerable', 'Weak', 'Poison'], [2, 2, 2])}, 1),
