...
Cards = {
    ...
    12: ('Icky', 4, 4, 'U', 'Add a Slimed to your hand', False, True, False, False, {effects.add_card_to_pile('hand', 50, 1, 't')}, 0),
    ...
    1013: ("Reckless Charge", 1, 0, 1, 'Deal 11 damage. Add a Curse your draw pile.', False, False, False, False, {effects.deal_attack_damage: (11, 1), effects.add_card_to_pile: ('draw', 'weak curse', 1, 't')}, 1),
    ...
    1016: ("Headbutt", 1, 0, 1, 'Deal 9 damage. Place a card from discard pile to top of the draw pile.', False, False, False, False, {effects.deal_attack_damage: (9, 1), effects.place_card_in_loction: ('discard', 1, 'draw')}, 1),
    ...
    1026: ("Cursed Blade", 2, 0, 1, 'Lose 3 HP. Deal 20 damage. Shuffle a Curse of the Blade into the draw pile.', False, False, False, False, {effects.lose_hp: (3, ), effects.deal_attack_damage: (20, 1), effects.add_card_to_pile: ('draw', 20, 1)}, 1),
    ...
    1030: ("Uncontrolled slash", 2, 0, 0, 'Deal 8 damage. Shuffle a Curse into the draw pile.', False, False, False, False, {effects.deal_attack_damage: (8, 1), effects.add_card_to_pile: ('draw', 'weak curse', 1)}, 1),
